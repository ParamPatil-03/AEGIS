...
start_marker = "// --- 0C. 3D CME Simulation (Three.js) ---"
end_marker = "        // --- 1. Clock ---"
...
if idx_start == -1 or idx_end == -1 or idx_start >= idx_end:
    print("Markers not found or invalid order!")
    exit(1)

new_js = """// --- 0C. 3D CME Simulation (Three.js) ---
        ...
        function initCMESimulation() {
            ...
            // Remove any existing canvas if already created
